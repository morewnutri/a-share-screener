...
def latest_complete_trade_date(now_dt: datetime, market_close_time: str = "15:10"):
...
def is_complete_daily_bar(last_bar_date, now_dt: datetime, market_close_time: str = "15:10") -> bool:
